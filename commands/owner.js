...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      const youtubeLink = 'https://discord.gg/grapes';
      const InstagramLink = 'https://www.instagram.com/dabronxa/';
